...
```bash
./asbmutil audit-events --start 2026-06-01T00:00:00Z --end 2026-06-14T23:59:59Z
```
...
```bash
./asbmutil audit-events --start 2026-06-01T00:00:00Z --end 2026-06-14T23:59:59Z --subject-id P8R2K47NF5X9
```
