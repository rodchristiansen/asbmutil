// Sources/core/Auth/FileCredentialStore.swift
...
public enum Keychain {
    ...
    @discardableResult
    public static func saveBlob(_ blob: KCBlob, profileName: String = "default") -> Int32 {
    ...
    public static func deleteBlob(profileName: String) -> Int32 {
        let account = "SBM_CREDENTIALS_\(profileName)"
    ...
    @discardableResult
    public static func setCurrentProfile(_ profileName: String) -> Int32 {
    ...
    @discardableResult
    public static func saveToken(_ token: Token, profileName: String = "default") -> Int32 {
    ...
    @discardableResult
    public static func deleteToken(profileName: String = "default") -> Int32 {
        let account = "SBM_TOKEN_\(profileName)"
